...
import faq from './components/CardGroup.vue'
...
@font-face {
  ...
  src: url(@/assets/quadrat_serial.woff2);
}

@font-face {
  font-family: "Open Sans";
  src: url(@/assets/openSans-600-normal.woff);
}
...
#app {
  ...
  color: #2c3e50;
  margin-top: 60px;
  background: url('@/assets/Repeating-BG.avif');
